...
export const Footers = () => {
  ...
  <footer className="   ">
    <ul className="nav justify-content-center border-bottom pb-3 mb-3">
      ...
      <li className="nav-item"><a style={{background:"white"}} href="/feed" className="nav-link px-2 text-muted">Feed Back</a></li>
      <li className="nav-item"><a style={{background:"white"}} href="/washerlogin" className="nav-link px-2 text-muted">Washer Login</a></li>
